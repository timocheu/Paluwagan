...
function BatchSection({ batch, member, contributions, payoutRounds }: BatchView) {
    return (
                ...
                <div className="rounded-2xl border border-[#0A2540]/5 bg-[#F6F9FC] p-6 lg:col-span-2">
                    ...
                    <div className="mt-5 flex flex-wrap items-center gap-4 text-sm text-[#0A2540]/70">
                        <span className="inline-flex items-center gap-2">
                            <RefreshCw className="h-4 w-4 text-[#635BFF]" strokeWidth={2} />
                            {member.autoPay ? 'Auto-pay on' : 'Manual contribution'}
                        </span>
                        <span className="inline-flex items-center gap-2">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        {p.paid ? (
                                            ...
                                            <CircleDashed className="h-5 w-5 text-[#0A2540]/30" strokeWidth={2} />
                                        )}
                                        <div>
                                    ...
                                    <span
                                        className={`text-xs font-medium ${
                                            p.paid ? 'text-emerald-600' : 'text-[#0A2540]/50'
                                        }`}
                                    >
...
export default function MemberBatch({ wallet, batches }: Props) {
    return (
        <>
                ...
                <main className="mx-auto max-w-5xl px-6 pt-10 lg:px-8">
                    ...
                    {batches.length === 0 ? (
                        <div className="rounded-2xl border border-dashed border-[#0A2540]/15 bg-white py-16 text-center">
                            <Users className="mx-auto h-10 w-10 text-[#0A2540]/30" strokeWidth={1.5} />
